...
public class Critique {
    ...
    public Critique(String id, String provider, String targetProvider, String critique, String agreements, String disagreements, String strengths, String weaknesses, LocalDateTime createdAt) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Critique build() {
            return new Critique(id, provider, targetProvider, critique, agreements, disagreements, strengths, weaknesses, createdAt);
        }
    }
}
