...
public class ModelResponse {
    ...
    public ModelResponse(String id, String provider, String modelName, String response, Long responseTime, Integer tokenUsage, LocalDateTime createdAt) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public ModelResponse build() {
            return new ModelResponse(id, provider, modelName, response, responseTime, tokenUsage, createdAt);
        }
    }
}
