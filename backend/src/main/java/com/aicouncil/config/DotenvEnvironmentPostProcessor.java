        ...
        if (envFile != null) {
            try {
                ...
                if (!dotenvProps.isEmpty()) {
                    log.info("DotenvEnvironmentPostProcessor: Successfully injected .env properties from {}", canonicalPath);
